...
# CATEGORIES = [
#     "Food", "Clothes", "Transport", "Utilities", "Health",
#     "Entertainment", "Shopping", "Travel", "Education",
#     "Rent", "Investments", "Dining", "Subscriptions", "Other"
# ]
...
#       { date: "2024-01-15", amount: 450.0, category: "Food" }
 
#     Output: dict of category → monthly DataFrame
#       { "Food": pd.DataFrame(columns=["month", "amount"]), ... }
#     """
...
#     """
#     Returns 'prophet_full', 'prophet_basic', or 'weighted_avg'
#     based on how many months of data exist.
#     """
...
#     """
#     Runs Facebook Prophet on the monthly series.
#     - prophet_full:  trend + yearly seasonality (needs 6+ months)
#     - prophet_basic: trend only              (needs 3+ months)
#     """
...
#         changepoint_prior_scale=0.1, # controls how flexible the trend is
#     )
#     model.fit(prophet_df)
 
#     # Ask Prophet to produce monthly future dates (MS = month start)
#     future = model.make_future_dataframe(periods=6, freq="MS")
#     forecast = model.predict(future)
 
#     # Keep only the 6 future months
...
#     """
#     Linearly weighted average: more recent months have higher weight.
#     All 6 future months get the same predicted value.
#     Confidence band = ± 1 std dev of historical amounts.
 
#     Example with 2 months:
#       Jan ₹4000 (weight 1), Feb ₹5000 (weight 2)
#       WMA = (4000×1 + 5000×2) / 3 = ₹4,667
#     """
#     amounts = monthly_df["amount"].values
#     n = len(amounts)
 
#     # weights: [1, 2, 3, ...n] — most recent month gets weight n
...
#     """
#     Compares each predicted month against the user's own historical mean.
#     z-score > 1.5  → trend: "high"  (spending spike predicted)
#     z-score < -1.5 → trend: "low"   (spending dip predicted)
#     else           → trend: "normal"
 
#     This is personal: the threshold is relative to that user's own history,
...
#         p["hist_avg"] = round(hist_mean, 2)  # useful for dashboard display
 
#     return predictions
 
 
# # ── Step 5: Master function — run all categories ──────────────────────────────
 
# def predict_all_categories(transactions: list[dict]) -> dict[str, list[dict]]:
#     """
#     Main entry point called by FastAPI after bank statement upload.
 
#     Returns:
#     {
#       "Food": [
#         { month, predicted_amount, lower_bound, upper_bound,
#           model, anomaly, trend, hist_avg },
#         ... × 6 months
#       ],
#       "Clothes": [ ... ],
#       ...
...
#         except Exception:
#             # Prophet can fail on unusual data — always fall back gracefully
#             predictions = forecast_weighted_avg(monthly_df)
...
# # {
# #   "Food": [
# #     { "month": "2025-04-01", "predicted_amount": 4050.0,
# #       "lower_bound": 3600.0, "upper_bound": 4500.0,
# #       "model": "prophet_full", "anomaly": false,
# #       "trend": "normal", "hist_avg": 4054.17 },
# #     ...5 more months
# #   ],
# #   "Clothes": [
# #     { "month": "2025-04-01", "predicted_amount": 1100.0, ... },
# #     ...
# #   ],
# #   "Transport": [...],
# #   "Utilities": [...],   # weighted_avg — only 2 months of data
# #   "Health":    [...],   # weighted_avg — only 1 month of data
# # }
